...
for boosted in [False, True]:
    ...
    for rich in RICH:
        ...
        vd = VideoAnalizer()
        clf.append(vd.train_OneClassSVM('../test_data/videos/real/thomas1', rich_features=rich, boosted=boosted))
        # Train Classifier 2 (other thomas)
        vd2 = VideoAnalizer()
        clf.append(vd2.train_OneClassSVM('../test_data/videos/real/thomas2', rich_features=rich, boosted=boosted))
        # Train Classifier 3 (moreno)
        vd3 = VideoAnalizer()
        clf.append(vd3.train_OneClassSVM('../test_data/videos/real/morez', rich_features=rich, boosted=boosted))
